...
import com.qinzhenning.BookLendSystem.GUI.AdminFrame.BookTableModel;
...
/**
 * @author qinzhenning
 * 时间：2012-7-4上午3:25:10
 * 文件：BookTableModel1.java
 * 项目：BookLendSystem 
 ...
 * 已借图书表格 的 数据模版
 */
public class HaveBorrowBookTableModel extends AbstractTableModel{
	...
	static Object[][] data = {{"","","","","","","","","",""},{"","","","","","","","","",""}} ;
		 ...
		 * 构造方法-传入一个ArrayList
		 */
		public HaveBorrowBookTableModel(ArrayList<Book> newList) {
		 ...
		 * 构造方法-传入一个对象
		 */
		public HaveBorrowBookTableModel(Book book) {
